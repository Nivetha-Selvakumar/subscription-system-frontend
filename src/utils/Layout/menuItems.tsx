...
export const menuConfig: MenuConfig = {
  admin: [
    ...
    { label: "Help and Feedback", path: "/admin/helpAndFeedback", icon: "mingcute:comment-2-line" },
  ],
  user: [
    { label: "Dashboard", path: "/user/dashboard", icon: "mingcute:grid-2-line" },
    { label: "Profile", path: "/user/profile", icon: "mingcute:user-4-line" },
    { label: "Subscription Plan", path: "/user/subscriptionPlan", icon: "mingcute:box-3-line" },
    ...
    { label: "Help and Feedback", path: "/user/supportTicket", icon: "mingcute:comment-2-line" },
  ],
  subscriber: [
    { label: "Dashboard", path: "/subscriber/dashboard", icon: "mingcute:grid-2-line" },
    { label: "Profile", path: "/subscriber/profile", icon: "mingcute:user-4-line" },
    { label: "Subscription Plan", path: "/subscriber/subscriptionPlan", icon: "mingcute:box-3-line" },
    { label: "Support Ticket", path: "/subscriber/supportTicket", icon: "mingcute:chat-4-line" },
    { label: "Payments", path: "/subscriber/payments", icon: "mingcute:wallet-4-line" },
    { label: "Help and Feedback", path: "/subscriber/supportTicket", icon: "mingcute:comment-2-line" },
  ],
};
