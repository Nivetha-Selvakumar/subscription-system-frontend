...
const UserSupportTicket: React.FC = () => {
    ...
    return (
        <Sidebar>
            <ToastContainer containerId="User-Support-Ticket-List" />
            ...
            <div className="list-parent-container">
                    ...
                    <div className="search-container">
                        ...
                        <div className="button-container">
                            ...
                            <Button
                                ...
                                onClick={() => navigate("/user/supportTicket/create")}
                            >
                                + Create Ticket
                            </Button>
                ...
                <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose}>
                    <MenuItem
                        onClick={() => {
                            navigate(`/user/supportTicket/view/${selectedTicket.id}`);
                            handleMenuClose();
                        }}
                    >
                    ...
                    <MenuItem
                        onClick={() => {
                            navigate(`/user/supportTicket/edit/${selectedTicket.id}`);
                            handleMenuClose();
                        }}
                    >
