...
const PaymentFilterModal: React.FC<PaymentFilterProps> = ({
  isModalOpen,
  toggleModal,
  onChangeFilter,
  initialFilter,
  ...
  return (
    <Modal open={isModalOpen} onClose={() => {}} disableEscapeKeyDown aria-labelledby="payment-filter">
      <Box sx={modalStyle}>
        <div className="flex justify-between items-center px-5 py-3 border-b border-gray-200 bg-gray-50 rounded-t-md">
          <h2 className="text-lg font-semibold text-gray-800">Payment Filter</h2>
